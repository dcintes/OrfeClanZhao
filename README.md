# Projecte L'orfe del clan Zhao

Projecte per a la PAC2 de Eines HTML i CSS II del master de desenvolupament d'aplicacion web de la UOC. Farem ús del Boilplate de la UOC
